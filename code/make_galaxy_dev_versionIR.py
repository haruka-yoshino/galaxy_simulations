...
#             "filter_selector": "wfc3_filter_w",
#             "norm_radio": "fftype_fNormalizeByFilter.wfc3uvis",
#             "norm_dropdown": "filter.wfc3uvis"
#         },
#         "IR": {
#             "url": "https://etc.stsci.edu/etc/input/wfc3ir/imaging/",
#             "filter_selector": "irfilt0",
#             "norm_radio": "fftype_fNormalizeByFilter.wfc3IR",
#             "norm_dropdown": "filter.wfc3IR"
#         }
#     },

#     "HST_ACS": {
#         "WFC": {
#             "url": "https://etc.stsci.edu/etc/input/acs/imaging/",
#             "filter_selector": ["acs_filter1", "acs_filter2"],
#             "norm_radio": "fftype_fNormalizeByFilter.acs",
#             "norm_dropdown": "filter.acs"
#         }
#     },
...
# 	    "Broad-band": {
# 	        "url": "https://etc.stsci.edu/etc/input/acs/imaging/",
# 	        "filter_selector": ["wfcfilt0", "wfcfilt1"],
...
# 	ugriz_dictionary = {"spec_band": "Optical", 
...
# 	IR_dictionary = {"spec_band": "IR", 
# 	"HST_WFC3": ["F105W", "F110W", "F125W", "F140W", "F160W"]
# 	}

# 	BB_dictionary = {"spec_band": "Broad-band",
# 	"HST_ACS": ["F435W", "F555W", "F606W", "F814W"]}
...
####
	...
	if bands == "ugriz":
		...
		red = "F775W" # "F140W" ##"CFHT_i_new" #
		green = "F475W"  # "F105W" #"CFHT_g" #

	elif bands == "IR":
		filters = IR_dictionary[obs_telescope]

		red = "F140W" ##"CFHT_i_new" #"F775W" # 
		green = "F105W" #"CFHT_g" #"F475W"  # 
...
###
	...
	###
	# THIS PART NEEDS MAJOR OVERHAUL IN ORDER TO INCORPORATE THE IR
	# FOR STARTERS IT ONLY USES UGRIZ_DICTIONARY - IT'S NOT MADE FOR IR_DICTIONARY
	###
	else:
		if lookup: 
	...
	# mag_comp.append(["CFHT_g", f"{galaxy_parameters["mag_total"]["CFHT_g"]:.2f}", f"{magnitude(np.sum(N_STARS * flux(CFHT_m_app["CFHT_g"]))):.2f}"])
	...
	mag_comp.append(["N_{RGB}", "-", f"{N_TOT:.2e}"])
	mag_comp.append(["N_{tot}", "-", f"{np.sum(N_STARS):.2e}"])
	...
	mag_comp.append(["N_{R>3Re}", "-", f"{len(R_ba[mask_gt_3Re])/len(R_ba):.5f}"])
	mag_comp.append(["L_{R>3Re}", "-", f"{L_gt_3Re / L_total:.5f}"])


	print(tabulate(mag_comp, headers=mag_comp_headers, tablefmt="grid", disable_numparse=True))


	# print(np.min(XROT), np.max(XROT))
	# exit()
...
###
# MAKE A DICTIONARY FOR THE SERSIC PROFILE
# 20 BINS
# SOME KEYS: 'COUNTS', 'EDGES', 'ELLIPSES', 'ANNULI', 'CENTERS_AVG', 'R_OBS', 'I_OBS', 'MASK_OBS' < INPUT TOO
# MAYBE? 'T_EFF', 'INIT_MASS'
###
...
# for i in range(1,40):
main(plot=False, save_pdf = False, ID_num=1362, lookup = False, bands = "ugriz", user_min_t = [0,0,0,0,0])
