...
####
	...
	if bands == "ugriz":
		...
		red = "F160W" #"F140W" ##"CFHT_i_new" #"F775W" # 
		green = "F125W" #"F105W" #"CFHT_g" #"F475W"  # 
	...
	mag_limit = 27.9 #np.min(m_app[red])+2 # 28#  
...
###
	...
	pickleFile = pklLoc + f"/pls_use_this_{bands}_{green}_{red}.pkl"
...
# for i in range(1,40):
main(plot=False, save_pdf = True, ID_num=1362, lookup = True, bands = "IR", user_min_t = [0,0,0,0,0])
